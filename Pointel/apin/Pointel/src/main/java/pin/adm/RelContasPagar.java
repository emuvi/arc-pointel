...
public class RelContasPagar extends Relatorio {

    public RelatorioFiltro filtro;

    public RelContasPagar() {
        super("Contas a Pagar", Tipo.Gra, RelatorioPagina.padraoGrafico(), new RelatorioCampo[]{
    ...
    public void finalizar() throws Exception {
        resultados = conexao.busca("SELECT DISTINCT ON (" + filtro.pegaOrdem("", "lancamentos.codigo").replaceAll("DESC", "") + ") "
                ...
                + filtro.pegaCondicao("WHERE", "lancamentos.tipo = 'P'")
