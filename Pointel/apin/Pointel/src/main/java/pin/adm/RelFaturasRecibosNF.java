...
public class RelFaturasRecibosNF extends Relatorio {
    ...
    public RelFaturasRecibosNF() throws Exception {
        this(null, null);
    }

    public RelFaturasRecibosNF(Object aSerie, Object aCodigo) throws Exception {
        super("Recibo NF", Tipo.Mat, RelatorioPagina.padraoMatricial(), new RelatorioCampo[]{
            ...
            new RelatorioCampo(10, 24, "fatura", RelatorioCampo.Area.DADOS_DETALHES, RelatorioCampo.Tp.CLASSE).botaClasse("pin.adm.RelFaturasRecibosNF", "ajustarCodigo"),
            ...
            new RelatorioCampo(9, 68, "RECIBO", RelatorioCampo.Area.DADOS_DETALHES, RelatorioCampo.Tp.TEXTO),
            ...
            new RelatorioCampo(19, 11, "REGISTRO:", RelatorioCampo.Area.DADOS_DETALHES, RelatorioCampo.Tp.TEXTO),
            ...
            new RelatorioCampo(25, 13, "PARA CLAREZA FIRMAMOS O PRESENTE RECIBO", RelatorioCampo.Area.DADOS_DETALHES, RelatorioCampo.Tp.TEXTO),
