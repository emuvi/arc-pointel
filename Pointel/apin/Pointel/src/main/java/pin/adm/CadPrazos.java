...
public class CadPrazos extends Cadastro {

    public CadPrazos() throws Exception {
        super("prazos", "Prazos", new Cmp[]{
            ...
            new Cmp(2, 1, "dias", "Dias", Dados.Tp.Int).botaDetalhe("chave", true),
