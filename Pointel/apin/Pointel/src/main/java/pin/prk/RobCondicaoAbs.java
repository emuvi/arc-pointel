...
public abstract class RobCondicaoAbs {
    ...
    public RobCondicaoAbs mRobotico(ServProcessarRoboticoExc robotico) {
        this.robotico = robotico;
        return this;
    }

    public abstract Boolean verifica() throws Exception;
