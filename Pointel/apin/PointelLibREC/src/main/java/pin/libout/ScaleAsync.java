...
import pin.libout.Scale.Method;
import pin.libout.Scale.Mode;
import pin.libout.Scale.Rotation;

/**
 * Class used to provide the asynchronous versions of all the methods defined in
 * {@link Scale} for the purpose of efficiently handling large amounts of image
 ...
 * to benefit from.
 * <p/>
 * Every method in this class wraps the matching methods in the {@link Scale}
 ...
 * <p/>
 * If you have used the {@link ScaleAsync} class and are trying to shut down a
 ...
 * to more closely monitor the shutting down process.
...
public class ScaleAsync {
	 ...
	 * and purge all operations before exiting.
	 * <p/>
	...
	/**
	 * @see Scale#apply(BufferedImage, BufferedImageOp[])
	 */
	public static Future<BufferedImage> apply(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.apply(src, ops);
			}
		});
	}

	/**
	 * @see Scale#crop(BufferedImage, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> crop(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.crop(src, width, height, ops);
			}
		});
	}

	/**
	 * @see Scale#crop(BufferedImage, int, int, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> crop(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.crop(src, x, y, width, height, ops);
			}
		});
	}

	/**
	 * @see Scale#pad(BufferedImage, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> pad(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.pad(src, padding, ops);
			}
		});
	}

	/**
	 * @see Scale#pad(BufferedImage, int, Color, BufferedImageOp[])
	 */
	public static Future<BufferedImage> pad(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.pad(src, padding, color, ops);
			}
		});
	}

	/**
	 * @see Scale#resize(BufferedImage, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, targetSize, ops);
			}
		});
	}

	/**
	 * @see Scale#resize(BufferedImage, Method, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, scalingMethod, targetSize, ops);
			}
		});
	}

	/**
	 * @see Scale#resize(BufferedImage, Mode, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, resizeMode, targetSize, ops);
			}
		});
	}

	/**
	 * @see Scale#resize(BufferedImage, Method, Mode, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, scalingMethod, resizeMode, targetSize,
						ops);
			}
		});
	}
	...
	/**
	 * @see Scale#resize(BufferedImage, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, targetWidth, targetHeight, ops);
			}
		});
	}

	/**
	 * @see Scale#resize(BufferedImage, Method, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, scalingMethod, targetWidth,
						targetHeight, ops);
			}
		});
	}
	...
	/**
	 * @see Scale#resize(BufferedImage, Mode, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, resizeMode, targetWidth, targetHeight,
						ops);
			}
		});
	}
	...
	/**
	 * @see Scale#resize(BufferedImage, Method, Mode, int, int, BufferedImageOp[])
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
			final Method scalingMethod, final Mode resizeMode,
			final int targetWidth, final int targetHeight,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.resize(src, scalingMethod, resizeMode,
	...
	/**
	 * @see Scale#rotate(BufferedImage, Rotation, BufferedImageOp[])
	 */
	public static Future<BufferedImage> rotate(final BufferedImage src,
		...
		return service.submit(new Callable<BufferedImage>() {
			public BufferedImage call() throws Exception {
				return Scale.rotate(src, rotation, ops);
			}
		});
	}
	 ...
	 * by {@link ScaleAsync} to process images, but don't want to have to write
	 * the implementation.
	 * 
	 * @author Riyad Kalla (software@thebuzzmedia.com)
	 * @since 4.0
