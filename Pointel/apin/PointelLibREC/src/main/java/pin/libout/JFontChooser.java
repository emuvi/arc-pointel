...
/**
 * The <code>JFontChooser</code> class is a swing component for font selection. This class has <code>JFileChooser</code> like APIs. The following code pops up a font chooser dialog.
 * <pre>
...
public class JFontChooser extends JComponent {
    ...
    private ResourceBundle messageCatalog = ResourceBundle.getBundle(JFontChooser.class.getName() + "Msgs", getLocale());
     ...
     */
    public JFontChooser() {
        this(DEFAULT_FONT_SIZE_STRINGS, true, true, true);
    }

    public JFontChooser(boolean fontFamily, boolean fontStyle, boolean fontSize) {
        this(DEFAULT_FONT_SIZE_STRINGS, fontFamily, fontStyle, fontSize);
    }
     ...
     * @param fontFamily Displays Font Family Panel
     * @param fontStyle Displays Font Style Panel
     * @param fontSize Displays Font Size Panel
     *
     */
    public JFontChooser(String[] fontSizeStrings, boolean fontFamily, boolean fontStyle, boolean fontSize) {
     ...
     *
     * @return the style of the selected font. <code>Font.PLAIN</code>, <code>Font.BOLD</code>, <code>Font.ITALIC</code>, <code>Font.BOLD|Font.ITALIC</code>
     *
     ...
     *
     * @param style the size of the selected font. <code>Font.PLAIN</code>, <code>Font.BOLD</code>, <code>Font.ITALIC</code>, or <code>Font.BOLD|Font.ITALIC</code>.
     *
     * @see java.awt.Font#PLAIN
     * @see java.awt.Font#BOLD
     * @see java.awt.Font#ITALIC
