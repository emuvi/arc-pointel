    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        if (e.getActionCommand().equals("apply")) {
            ...
            if (sm.isSelectionEmpty()) {
                SimpleInfoDialog sidAbout = new SimpleInfoDialog(parent, "Erro", true, "Nenhuma Imagem Selecionada", SimpleInfoDialog.ERROR).mostra();
    ...
    private boolean validateControls() {
        ...
        if (!ImageWidth.getText().equals("")) {
            try {
                ...
                result = false;
                SimpleInfoDialog sidAbout = new SimpleInfoDialog(parent, "Erro", true, "Image Largura Não É Inteira", SimpleInfoDialog.ERROR).mostra();
        ...
        if (result && !ImageHeight.getText().equals("")) {
            try {
                ...
                result = false;
                SimpleInfoDialog sidAbout = new SimpleInfoDialog(parent, "Error", true, "Image Altura Não É Inteira", SimpleInfoDialog.ERROR).mostra();
