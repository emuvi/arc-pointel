...
/**
 * Class for providing a dialog that lets the user specify arguments for the Search Find/Replace functions
 */
public class SearchDialog extends JDialog {
    ...
    public SearchDialog(Frame parent, String title, boolean bModal, boolean bIsReplace, boolean bCaseSetting, boolean bTopSetting) {
        ...
        final JCheckBox jchkCase = new JCheckBox("Maiúsculas", bCaseSetting);
        final JCheckBox jchkTop = new JCheckBox("A partir do Topo", bTopSetting);
        final JCheckBox jchkAll = new JCheckBox("Troca Tudo", false);
        final Object[] buttonLabels = {"Confirma", "Cancela"};
        if (bIsReplace) {
