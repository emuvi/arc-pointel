...
public class UtlMom {
    ...
    public static String formato = "dd/MM/yyyy HH:mm:ss.SSS";
    public static String formatoSQL = "yyyy-MM-dd HH:mm:ss.SSS";
    public static String formatoMaquina = "yyyy-MM-dd-HH-mm-ss-SSS";
    ...
    public static Boolean eh(Object oValor) {
        ...
        if (oValor != null) {
            if (oValor instanceof java.util.Date) {
                ...
                retorno = true;
            } else if (oValor instanceof VMom) {
                retorno = true;
            }
        }
        return retorno;
    ...
    public static Boolean eh(Class daClasse) {
        ...
        if (daClasse != null) {
            if (java.util.Date.class.isAssignableFrom(UtlBin.pegaDaPrimitiva(daClasse))) {
                ...
                retorno = true;
            } else if (VMom.class.isAssignableFrom(daClasse)) {
                retorno = true;
            }
        }
        return retorno;
